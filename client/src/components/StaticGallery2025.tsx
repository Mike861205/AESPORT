...
const StaticGallery: React.FC = () => {
  ...
  // Galería con imágenes actualizadas 2025
  const images = [
    {
      id: 1,
    ...
    },
    {
      ...
      title: 'FC Zorritos',
      subtitle: 'Orgullo de Los Cabos 2025'
    },
    {
      id: 9,
    ...
    {
      id: 11,
      url: '/gallery-images/487407341_942303264756956_7863574062028340197_n.jpg',
      title: 'LCST 5ta Edición',
      subtitle: 'Mejores Momentos 2024'
    },
    {
      id: 12,
      url: '/gallery-images/481669276_922157023438247_8712901074579883240_n.jpg',
      title: 'Categorías Juveniles 2025',
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {images.map((image) => (
          <div key={image.id} className="relative group overflow-hidden rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300">
            <img
              src={image.url}
              alt={image.title}
              ...
              loading="lazy"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-primary to-transparent opacity-50 group-hover:opacity-80 transition-all duration-300 flex items-end justify-center">
              <div className="text-white p-6 text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                <p className="font-montserrat font-bold text-xl mb-1">{image.title}</p>
